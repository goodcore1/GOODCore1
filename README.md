...
GOOD Core is the GOOD blockchain implementation and command-line interface.

**NOTE:** The official GOOD git repository location, default branch, and submodule remotes were recently changed. Existing
repositories can be updated with the following steps:

    git remote set-url origin https://github.com/goodcore1/good-core.git
    git checkout master
...
[wiki](https://github.com/goodcore1/good-core/wiki).
...
To build after all dependencies are installed:
    ...
    git clone https://github.com/goodcore1/good-core.git
    cd good-core
...
**NOTE:** GOOD requires an [OpenSSL](https://www.openssl.org/) version in the 1.0.x series. OpenSSL 1.1.0 and newer are NOT supported. If your system OpenSSL version is newer, then you will need to manually provide an older version of OpenSSL and specify it to CMake using `-DOPENSSL_INCLUDE_DIR`, `-DOPENSSL_SSL_LIBRARY`, and `-DOPENSSL_CRYPTO_LIBRARY`.

**NOTE:** GOOD requires a [Boost](http://www.boost.org/) version in the range [1.57, 1.63]. Versions earlier than
...
**NOTE:** By default the witness node will start in reduced memory ram mode by using some of the commands detailed in [Memory reduction for nodes](https://github.com/goodcore1/good-core/wiki/Memory-reduction-for-nodes).
...
GOOD Core bugs can be reported directly to the [issue tracker](https://github.com/goodcore1/good-core/issues).
...
- The answer to the previous question was really confusing.  Can you make it clearer?
    ...
    your asset's ID will be `1.3.29`.  Asset `0` is special (it's GOOD, which is considered the "core asset").
...
License
-------
GOOD Core is under the MIT license. See [LICENSE](https://github.com/goodcore1/good-core/blob/master/LICENSE.txt)
